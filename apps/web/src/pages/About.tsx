  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div id="about-content" style={{ maxWidth: 680, margin: '0 auto', padding: '8rem 2rem 6rem' }}>
        ...
        <p className="justify-desktop" style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.8rem', color: muted, lineHeight: 1.9, marginBottom: '0.8rem', } }>When residuals display the same pattern of deviation across independent domains, the system measures whether that correspondence is likely to have occurred by chance.</p>
        <p className="justify-desktop" style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.8rem', color: muted, lineHeight: 1.9, marginBottom: '0.8rem', } }>Where correspondence persists beyond threshold, alvissara generates a hypothesis describing a possible hidden common cause.</p>
